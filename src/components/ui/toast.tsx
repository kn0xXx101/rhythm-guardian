...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed left-0 right-0 top-0 z-[100] flex max-h-screen w-full flex-col-reverse px-3 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] sm:bottom-0 sm:left-auto sm:right-0 sm:top-auto sm:flex-col sm:px-4 sm:pb-4 sm:pt-4 md:max-w-[420px]',
      className
    )}
    {...props}
  />
...
/**
 * Toast Progress Bar for showing async action progress
 */
...
>(({ className, progress = 0, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('absolute bottom-0 left-0 right-0 h-1 bg-current/20', className)}
    {...props}
  >
    <div
      className="h-full bg-current/40 transition-all duration-300 ease-out"
